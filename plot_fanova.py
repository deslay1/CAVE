...
key = "postgres"
results_file = f"./CAVE/output/{key}/30D_wikipedia.json" # Cave results file
output_format = "eps" # or e.g. png
output_image = f"./CAVE/output/{key}/fanova_wikipedia.{output_format}" # Output image path
title = f"Test"
...
# Do some formatting: rounding and give terms that don't exist a value of zero.
def format(d):
    new = d.copy()
    for x in d:
